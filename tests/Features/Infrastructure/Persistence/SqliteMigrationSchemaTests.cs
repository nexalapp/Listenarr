...
public class SqliteMigrationSchemaTests : BaseTests
{
    ...
    private const string TagJobsMigrationId =
    ...
    private const string RootFolderLibraryMarkerMigrationId =
        "20260910210625_AddRootFolderLibraryMarkerId";
    private const string AudiobookFileLockedTagsMigrationId =
        "20260911124959_AddAudiobookFileLockedTags";
    private const string AudiobookFilePathLockMigrationId =
        "20260911142625_AddAudiobookFilePathLock";
    private const string TagJobSelectedFileIdsMigrationId =
    ...
    private const string LibraryTagCacheEntriesMigrationId =
        "20260917015423_AddLibraryTagCacheEntries";
    private const string AuthorAliasesMigrationId =
    ...
    private const string FileNotFoundMigrationId =
    ...
    public async Task MigrationHistory_ContainsOnlyRetainedRepairsAndConsolidatedPrMigrationAfterCanary()
    {
        ...
        Assert.Equal(
            [
                ...
                RootFolderLibraryMarkerMigrationId,
