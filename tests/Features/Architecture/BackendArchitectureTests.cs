...
public sealed class BackendArchitectureTests : BaseTests
{
    ...
    public void ImportDestinationBoundaries_RequireExplicitFilesystemSemantics()
    {
        var files = new[]
        {
            ...
            "listenarr.api/Features/Downloads/ManualImportWorkflow.cs",
            "listenarr.api/Features/Downloads/ManualImportWorkflow.ProcessItem.cs",
            "listenarr.api/Features/Downloads/ManualImportWorkflow.PathSemantics.cs",
